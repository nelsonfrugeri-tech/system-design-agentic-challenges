...
from harness.application.ports.tracing import Tracing, TurnTrace
...
class LangfuseTracing(Tracing):
    ...
    @classmethod
    def disabled(cls) -> "LangfuseTracing":
        return cls(None)
    ...
    @contextmanager
    def turn(self, index: int, message: str) -> Iterator[LangfuseTurn]:
        ...
        with self.client.start_as_current_observation(
            ...
            yield LangfuseTurn(headers, span)
...
def from_environment() -> tuple[LangfuseTracing, str | None]:
    ...
    if not (host and public_key and secret_key):
        return LangfuseTracing.disabled(), (
    ...
    try:
        ...
        return LangfuseTracing.disabled(), f"Langfuse at {host} did not answer: {error}"
    ...
    return LangfuseTracing(client), None
